...
export const metadata: Metadata = generateSEOMetadata({
  title: 'How to Choose Marketing Channel | Yansi.IO',
      ...
      <Section variant="dark">
        <Container size="lg">
          ...
          <p className="text-lg text-white/70">
            Guide to choosing marketing channels
          </p>
        </Container>
      </Section>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about How to Choose Marketing Channel will be added here.
            </p>
          </div>
        </Container>
      </Section>

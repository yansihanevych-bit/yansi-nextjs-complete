...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Google Ads | Yansi.IO',
  description: 'Maximize ROI with Google Ads expertise',
});

export default function ServicesGoogle-adsPage() {
  return (
    <>
      ...
      <Section variant="dark">
        <Container size="lg">
          ...
          <p className="text-lg text-white/70">
            Maximize ROI with Google Ads expertise
          </p>
        </Container>
      </Section>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about Google Ads will be added here.
            </p>
          </div>
        </Container>
      </Section>

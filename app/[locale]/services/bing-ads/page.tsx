...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Bing Ads | Yansi.IO',
  description: 'Reach users on Microsoft's advertising network',
});

export default function ServicesBing-adsPage() {
  return (
    <>
      ...
      <Section variant="dark">
        <Container size="lg">
          ...
          <p className="text-lg text-white/70">
            Reach users on Microsoft's advertising network
          </p>
        </Container>
      </Section>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about Bing Ads will be added here.
            </p>
          </div>
        </Container>
      </Section>

...
export const metadata: Metadata = generateSEOMetadata({
  title: 'X Ads | Yansi.IO',
  description: 'Twitter/X advertising campaigns',
});

export default function ServicesX-adsPage() {
  return (
    <>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about X Ads will be added here.
            </p>
          </div>
        </Container>
      </Section>

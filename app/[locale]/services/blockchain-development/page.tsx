...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Blockchain Development | Yansi.IO',
  description: 'Web3 & blockchain solutions',
});

export default function ServicesBlockchain-developmentPage() {
  return (
    <>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about Blockchain Development will be added here.
            </p>
          </div>
        </Container>
      </Section>

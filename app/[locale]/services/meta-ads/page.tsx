...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Meta Ads | Yansi.IO',
  description: 'Facebook & Instagram advertising solutions',
});

export default function ServicesMeta-adsPage() {
  return (
    <>
      ...
      <Section variant="dark">
        <Container size="lg">
          ...
          <p className="text-lg text-white/70">
            Facebook & Instagram advertising solutions
          </p>
        </Container>
      </Section>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about Meta Ads will be added here.
            </p>
          </div>
        </Container>
      </Section>

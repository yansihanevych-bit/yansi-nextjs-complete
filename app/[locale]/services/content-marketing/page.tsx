...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Content Marketing | Yansi.IO',
  description: 'Engaging content that drives growth',
});

export default function ServicesContent-marketingPage() {
  return (
    <>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about Content Marketing will be added here.
            </p>
          </div>
        </Container>
      </Section>

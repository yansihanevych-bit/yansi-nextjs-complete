...
export const metadata: Metadata = generateSEOMetadata({
  title: 'TikTok Ads | Yansi.IO',
  description: 'Engage the TikTok audience with targeted campaigns',
});

export default function ServicesTiktok-adsPage() {
  return (
    <>
      ...
      <Section variant="dark">
        <Container size="lg">
          ...
          <p className="text-lg text-white/70">
            Engage the TikTok audience with targeted campaigns
          </p>
        </Container>
      </Section>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about TikTok Ads will be added here.
            </p>
          </div>
        </Container>
      </Section>

...
export const metadata: Metadata = generateSEOMetadata({
  title: 'YouTube Ads | Yansi.IO',
  description: 'Video advertising that drives results',
});

export default function ServicesYoutube-adsPage() {
  return (
    <>
      ...
      <Section variant="dark">
        <Container size="lg">
          ...
          <p className="text-lg text-white/70">
            Video advertising that drives results
          </p>
        </Container>
      </Section>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about YouTube Ads will be added here.
            </p>
          </div>
        </Container>
      </Section>

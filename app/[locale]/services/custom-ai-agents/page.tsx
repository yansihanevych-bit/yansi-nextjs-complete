...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Custom AI Agents | Yansi.IO',
  description: 'AI agents built for your needs',
});

export default function ServicesCustom-ai-agentsPage() {
  return (
    <>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about Custom AI Agents will be added here.
            </p>
          </div>
        </Container>
      </Section>

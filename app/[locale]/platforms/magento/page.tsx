...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Magento | Yansi.IO',
  description: 'Magento e-commerce solutions',
});

export default function PlatformsMagentoPage() {
  return (
    <>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about Magento will be added here.
            </p>
          </div>
        </Container>
      </Section>

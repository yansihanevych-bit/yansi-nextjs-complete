...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Shopify | Yansi.IO',
  description: 'Shopify store optimization',
});

export default function PlatformsShopifyPage() {
  return (
    <>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about Shopify will be added here.
            </p>
          </div>
        </Container>
      </Section>

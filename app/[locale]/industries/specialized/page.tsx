...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Specialized Industries | Yansi.IO',
  description: 'Solutions for specialized sectors',
});

export default function IndustriesSpecializedPage() {
  return (
    <>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about Specialized Industries will be added here.
            </p>
          </div>
        </Container>
      </Section>

...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Supply Chain & Logistics | Yansi.IO',
  description: 'Supply chain optimization',
});

export default function IndustriesSupply-chainPage() {
  return (
    <>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about Supply Chain & Logistics will be added here.
            </p>
          </div>
        </Container>
      </Section>

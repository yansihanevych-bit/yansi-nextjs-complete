...
export const metadata: Metadata = generateSEOMetadata({
  title: 'AI Agents OSINT | Yansi.IO',
  description: 'Open Source Intelligence AI',
});

export default function Ai-agentsOsintPage() {
  return (
    <>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about AI Agents OSINT will be added here.
            </p>
          </div>
        </Container>
      </Section>

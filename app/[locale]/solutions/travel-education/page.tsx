...
export const metadata: Metadata = generateSEOMetadata({
  title: 'Travel & Education | Yansi.IO',
  description: 'Solutions for travel & education',
});

export default function SolutionsTravel-educationPage() {
  return (
    <>
      ...
      <Section variant="dark">
        <Container size="lg">
          ...
          <p className="text-lg text-white/70">
            Solutions for travel & education
          </p>
        </Container>
      </Section>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about Travel & Education will be added here.
            </p>
          </div>
        </Container>
      </Section>

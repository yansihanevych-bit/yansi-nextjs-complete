...
export const metadata: Metadata = generateSEOMetadata({
  title: 'UTM Generator | Yansi.IO',
  description: 'UTM parameter generator',
});

export default function ToolsUtm-generatorPage() {
  return (
    <>
        ...
        <Container size="lg">
          <div className="max-w-3xl space-y-6">
            <p className="text-white/70">
              Detailed content about UTM Generator will be added here.
            </p>
          </div>
        </Container>
      </Section>
